...
export function ExpenseLogReportPage() {
  ...
  const handleDownload = async () => {
    ...
    try {
      await downloadExpenseLogReport(selectedYear, selectedFormat);
  ...
  return (
    <PageContainer>
      ...
      <h1 className="mb-6 text-xl font-bold text-[var(--color-text-primary)]">{t('reports.expenseLog', 'Expense Log')}</h1>
