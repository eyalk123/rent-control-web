...
export const TIERS: Tier[] = [
  { id: 'free', min: 1, max: 2, monthly: null, yearly: null },
  { id: 'tier1', min: 3, max: 8, monthly: 15, yearly: 150 },
  { id: 'tier2', min: 9, max: 15, monthly: 20, yearly: 200 },
  { id: 'tier3', min: 16, max: null, monthly: 25, yearly: 250 },
];
