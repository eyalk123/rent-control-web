export function getLeaseYearLabel(leaseStart: string | undefined, index: number): string {
...
export function isCurrentLeaseYear(leaseStart: string | undefined, index: number): boolean {
